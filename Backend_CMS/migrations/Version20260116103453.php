 ...
 */
final class Version20260116103453 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bloc (id INT AUTO_INCREMENT NOT NULL, tenant_id INT NOT NULL, created_by_id INT NOT NULL, article_id INT NOT NULL, visualisation_id INT DEFAULT NULL, media_id INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', type_bloc VARCHAR(255) NOT NULL, position INT NOT NULL, contenu_json JSON NOT NULL, INDEX IDX_C778955A9033212A (tenant_id), INDEX IDX_C778955AB03A8386 (created_by_id), INDEX IDX_C778955A7294869C (article_id), UNIQUE INDEX UNIQ_C778955A1A36181E (visualisation_id), INDEX IDX_C778955AEA9FDD75 (media_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE colonne_dataset (id INT AUTO_INCREMENT NOT NULL, tenant_id INT NOT NULL, created_by_id INT NOT NULL, dataset_id INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', nom_colonne LONGTEXT NOT NULL, type_colonne VARCHAR(255) NOT NULL, INDEX IDX_EDE4B5AC9033212A (tenant_id), INDEX IDX_EDE4B5ACB03A8386 (created_by_id), INDEX IDX_EDE4B5ACD47C2D1B (dataset_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE dataset (id INT AUTO_INCREMENT NOT NULL, tenant_id INT NOT NULL, created_by_id INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, type_source VARCHAR(255) NOT NULL, url_source VARCHAR(255) NOT NULL, delimiter VARCHAR(5) DEFAULT \';\' NOT NULL, api_config JSON DEFAULT NULL, INDEX IDX_B7A041D09033212A (tenant_id), INDEX IDX_B7A041D0B03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
